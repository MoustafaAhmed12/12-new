...
(function () {
  ...
  const languages = {
    ...
    ar: {
      ...
      design_build_desc:
        "  نقدم في شركة أبعاد المتحدة خدمة تصميم – بناء' كحل متكامل يوفّر على عملائنا الوقت والجهد، حيث نتولى مسؤولية المشروع من مرحلة الفكرة الأولى وحتى التسليم النهائي. يعمل فريقنا الهندسي جنبًا إلى جنب مع فريق التنفيذ لضمان التناغم الكامل بين الرؤية التصميمية والتنفيذ على أرض الواقع. نضمن من خلال هذه الخدمة تحقيق أعلى درجات الكفاءة والجودة، مع الالتزام التام بالميزانية والجدول الزمني المحدد.",
